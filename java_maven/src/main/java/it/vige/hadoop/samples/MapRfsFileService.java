...
public class MapRfsFileService {
	private Configuration conf = new Configuration();
	private Path maprfsCoreSitePath = new Path("kms-site.xml");
	private Path maprfsSitePath = new Path("maprfs-site.xml");
	private FileSystem fileSystem;

	public MapRfsFileService() throws IOException {
